...
export class GrassMaterial {
  ...
  setupGUI(gui: GUI) {
    ...
    folder.addColor(this.grassColorProps, "baseColor").onChange((value: any) => {
      this.uniforms.baseColor.value.set(value);
    });
    folder.addColor(this.grassColorProps, "tipColor1").onChange((value: any) => {
      this.uniforms.tipColor1.value.set(value);
    });
    folder.addColor(this.grassColorProps, "tipColor2").onChange((value: any) => {
